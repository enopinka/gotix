        ...
        <AdminLayout>
            <div className="p-6 space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <StatCard icon={<BarChart3 />} title="Sales" value="$12,340" />
                    <StatCard icon={<Settings />} title="Settings" value="12 Configs" />
                </div>

                {/* Welcome Message */}
                <div className="bg-white shadow-md rounded-xl p-6">
                    <h2 className="text-xl font-semibold mb-2">Selamat Datang, Admin! 🎉</h2>
                    <p className="text-gray-600">Berikut adalah statitsik dari web GOTIX Anda.</p>
                </div>
            </div>
        </AdminLayout>
    );
